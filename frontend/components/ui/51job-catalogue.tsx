...
// 51job 官网侧边栏导航项（10 大模块标准顺序）
const CATALOGUE_ITEMS: CatalogueItem[] = [
  { key: "baseInfo",       label: "基本信息",  sectionId: "section-baseInfo" },
  { key: "selfEval",       label: "个人优势",  sectionId: "section-selfEval" },
  { key: "intentions",     label: "求职意向",  sectionId: "section-intentions" },
  ...
  { key: "portfolio",      label: "个人作品",  sectionId: "section-portfolio" },
  { key: "skills",         label: "专业技能",  sectionId: "section-skills" },
  { key: "certifications", label: "资格证书",  sectionId: "section-certifications" },
]

const JOB51_PRIMARY = "#FF6B00"

interface Job51CatalogueProps {
  /** 哪些 section key 有数据（没数据的隐藏；不传默认展示全部） */
  visibleKeys?: string[]
}

export function Job51Catalogue({ visibleKeys }: Job51CatalogueProps) {
  const [activeKey, setActiveKey] = useState<string>("basic-info")
            ...
            return (
              <li
                ...
                style={{
                  ...
                  fontSize: 13,
                  lineHeight: "20px",
                  color: isActive ? JOB51_PRIMARY : "#444",
