...
import { Sparkles, Target, XCircle , AlertTriangle } from "lucide-react"
...
function PendingSummaryBar() {
  ...
  const jumpToFirst = () => {
    for (const key of pendingKeys) {
      const el = document.querySelector(`[data-section-id="${key}"]`) || document.getElementById(key)
      if (el) {
        el.scrollIntoView({ behavior: "smooth", block: "center" })
        return
      }
